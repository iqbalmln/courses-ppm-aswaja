  ...
  <div class="flex flex-col gap-12 md:gap-24 py-24 md:py-12">
    ...
    <figure class="md:h-[700px]">
      <img
        ...
        src="https://aswajanusantara.com/wp-content/uploads/2020/12/1-slider-2.png"
        alt=""
      />
    </figure>
      ...
      <div class="pt-4 flex flex-col md:flex-row justify-between gap-6">
        ...
        <div class="flex-1 flex flex-col gap-4 font-light text-sm md:text-base">
          <p>
            ...
            keniscayaan, globalisasi menghadirkan arena kompetisi antar-individu
            berbasis keunggulan sumber daya manusia. Yang survive adalah mereka
            yang berkualitas dan menguasai teknologi informasi. Ruang di mana
          ...
          <p>
            ...
            yang beriman-bertaqwa, berintegritas, berkemampuan pikir kritis,
            bertindak transformatif, dan memiliki soft-skill abad 21. Oleh
            karena itu, Yayasan Aswaja Nusantara yang berdiri sejak tahun 2011,
            membuat pelatihan kerja dan pemberdayaan Masyarakat yang mana
      ...
      <div class="pb-4 flex flex-col md:flex-row-reverse justify-between gap-6">
        ...
        <div class="flex-1 flex flex-col gap-4 font-light text-sm md:text-base">
          <p>
            ...
            produktif agar dapat memulai karir atau usaha secara profesional.
            Dengan mentor yang sekaligus praktisi profesional dapat memberikan
            dampak tersendiri, seperti gambaran industri secara menyeluruh,
            hardskill, dan softskill yang relevan. Metode pembelajaran yang
            ditekankan Aswaja Nusantara Career Development Center adalah long
            life learning, yang mana murid akan dibekali hardskill dan softskill
            yang cukup untuk menjadi bekal pengembangan karir secara mandiri,
            dan sekaligus koneksi dari mentor praktisi untuk membantu masuk ke
            industri.
          </p>
        </div>
      </div>
